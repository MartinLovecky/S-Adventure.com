...
<table cellspacing="0" cellpadding="0" style="width:100%">
  ...
  <tr>
    ...
    <p style="font-size:15px;line-height:22px;margin:15px 0;padding:0;font-weight:bold">Resetovat heslo?</p>
    <p style="font-size:15px;line-height:22px;margin:15px 0;padding:0">
        Pokud jste nám poslali požadavek na obnovení hesla účtu <strong><?php echo $username;?></strong>.
    ...
    <span style="text-align:center;display:block">
       <a href="http://sadventure.com/resetPassword?action=<?php echo $token;?>&x=<?php echo $id;?>" style="background:#28a745;border-radius:4px;color:#fff;display:inline-block;font-weight:700;margin:16px auto 32px;padding:15px 25px;text-decoration:none" target="_blank" >
        Reset Hesla &nbsp;»
       </a>
   </span>
    <p style="font-size:15px;line-height:22px;margin:15px 0;padding:0">
