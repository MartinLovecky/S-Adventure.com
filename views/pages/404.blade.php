...
<body translate="no">
    ...
    <div class="box__ghost">
      ...
      <div class="box__ghost-container">
        <div class="box__ghost-eyes" style="transform: translate(-51.7708%, -142.421%);">
    ...
    <div class="box__description">
      <div class="box__description-container">
        ...
        <div class="box__description-text">Stránka <b style="color:red;">{{$selector->action}}</b> kterou hledáte nexistuje</div>
      </div>
